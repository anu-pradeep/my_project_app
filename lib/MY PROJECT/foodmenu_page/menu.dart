    ...
    return Scaffold(
        body: CustomScrollView(
          slivers: [SliverAppBar(backgroundColor: Colors.yellow[300],
            ...
            ListView.builder(
              ...
              itemCount: 64, // Replace with your actual item count
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ElevatedButton.icon(onPressed: (){
                        setState(() {
                          if(wishlist.contains(items[index])){wishlist.remove(items[index]);}
                          else{ wishlist.add(items[index]);}
                        });
                      },
                          icon: Icon(Icons.favorite),
                          label: Text(wishlist.contains(items[index])? "Remove":"Add",style: TextStyle(color: Colors.black),),
        ...
        bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(icon: IconButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>drinklistScreen(drinklist:[])));
